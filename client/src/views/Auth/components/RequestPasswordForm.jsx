const RequestPasswordForm = () => {
    ...
    return ( 
        <form action="" className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex-col items-center space-x-4">
            <div className="text-center space-y-2 sm:text-left">

                <p className="text-lg text-black font-semibold">
                    Recuperacion de contraseña
                </p>
                <input type="text" className="focus:outline-none " placeholder="Numero de cuenta"/>
